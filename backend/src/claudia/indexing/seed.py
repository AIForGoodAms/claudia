...
from claudia.indexing import arasaac, describe

DEFAULT_WORDS_PATH = Path(__file__).resolve().parent / "core_words.txt"
...
def main(argv=None):
    ...
    parser.add_argument("--words-path", default=str(DEFAULT_WORDS_PATH))
    parser.add_argument("--unresolved-path", default="unresolved.txt")
